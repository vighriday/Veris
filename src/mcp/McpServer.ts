    ...
    private toolDefinitions() {
        return [
            ...
            { name: "export_behavioral_graph",
              description: "Returns behavioral graph (nodes + edges, both DependsOn and Invokes). Workflows colored by domain.",
              inputSchema: { type: "object", properties: {}, required: [] } },
            ...
            { name: "generate_verification_plan",
              description: "Generates Tier 1/2/3 validation directives keyed to impacted nodes. Tier 3 = adversarial.",
              inputSchema: { type: "object", properties: {}, required: [] } },
            ...
            { name: "confidence_history",
              description: "Returns confidence + execution depth trend over the last N runs from local state.",
